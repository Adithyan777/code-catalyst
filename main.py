...
from workflows.docker import DockerSetupWorkflow
from trial import custom_print_response
...
def some_command():
   ...
   if dev_env == "normal":
        worfklow = NormalSetupWorkflow(api_key,console)
        response = worfklow.run(project_name,project_description)
      # pprint_run_response(response)
   else:
        worfklow = DockerSetupWorkflow(api_key,console)
        response = worfklow.run(project_name,project_description)
