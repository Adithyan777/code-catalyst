...
from helper_functions import extract_description,get_sys_msg_normal,extract_summary
...
def initiate_multi_agents_normal(api_key, project_name, project_description, console):
    ...
    ExtractInfoAgent = AssistantAgent(
        "info_extracter",
        system_message = normal_extract_info_agent,
...
# -----------------------------------------------------  GROUP CHAT CODE  ------------------------------------------------------------------------
    ...
    # todo - add FeedbackAgent
    
    # FeedbackAgent = UserProxyAgent(
    #     "FeedbackAgent",
    #     system_message="",
    #     llm_config=llm_config,
    #     code_execution_config = False,
    ...
    group_chat = CustomGroupChat(
        agents=[initializer,TemplateAgent,TesterAgent,HumanProxyGroup],
        messages=[],
    ...
    # console.print(f"Extracted Description: \n[bold]{extracted_desc}[/bold]")
